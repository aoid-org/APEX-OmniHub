    ...
    <div class="hero-right rv d1">
      <div class="hero-art-wrap">
        <svg class="hero-art-svg" viewBox="0 0 520 540" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
          ...
          <g clip-path="url(#sclip)"><image href="/apex-badge.svg" xlink:href="/apex-badge.svg" x="202" y="203" width="116" height="124" preserveAspectRatio="xMidYMid meet" filter="url(#coreGlow)"><animate attributeName="opacity" values="0.82;1;0.82" dur="2.6s" repeatCount="indefinite"/></image></g>
          <!-- Pulse rings -->
