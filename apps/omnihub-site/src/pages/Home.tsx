        ...
        <svg class="hero-art-svg" viewBox="0 0 520 540" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
          <defs>
            ...
            <clipPath id="sclip"><circle cx="260" cy="265" r="152"/></clipPath>
                      ...
                      <!-- FIXED: was broken image ref — now inline SVG, no external dependency -->
                      <svg x="170" y="165" width="140" height="140" viewBox="0 0 72 72" fill="none" opacity="0.92"><circle cx="36" cy="36" r="34" stroke="rgba(201,168,76,0.6)" stroke-width="1.5"/><circle cx="36" cy="36" r="26" stroke="rgba(201,168,76,0.3)" stroke-width="1"/><circle cx="36" cy="36" r="8" fill="#C9A84C" opacity="0.9"/><line x1="36" y1="2" x2="36" y2="20" stroke="rgba(201,168,76,0.5)" stroke-width="1"/><line x1="36" y1="52" x2="36" y2="70" stroke="rgba(201,168,76,0.5)" stroke-width="1"/><line x1="2" y1="36" x2="20" y2="36" stroke="rgba(201,168,76,0.5)" stroke-width="1"/><line x1="52" y1="36" x2="70" y2="36" stroke="rgba(201,168,76,0.5)" stroke-width="1"/><line x1="12" y1="12" x2="25" y2="25" stroke="rgba(201,168,76,0.3)" stroke-width="1"/><line x1="47" y1="47" x2="60" y2="60" stroke="rgba(201,168,76,0.3)" stroke-width="1"/><line x1="60" y1="12" x2="47" y2="25" stroke="rgba(201,168,76,0.3)" stroke-width="1"/><line x1="25" y1="47" x2="12" y2="60" stroke="rgba(201,168,76,0.3)" stroke-width="1"/></svg>
          <!-- Atmosphere -->
          ...
          <g clip-path="url(#sclip)"><svg x="202" y="203" width="116" height="124" viewBox="0 0 72 72" fill="none" filter="url(#coreGlow)"><animate attributeName="opacity" values="0.82;1;0.82" dur="2.6s" repeatCount="indefinite"/><circle cx="36" cy="36" r="34" stroke="rgba(201,168,76,0.6)" stroke-width="1.5"/><circle cx="36" cy="36" r="26" stroke="rgba(201,168,76,0.3)" stroke-width="1"/><circle cx="36" cy="36" r="8" fill="#C9A84C" opacity="0.9"/><line x1="36" y1="2" x2="36" y2="20" stroke="rgba(201,168,76,0.5)" stroke-width="1"/><line x1="36" y1="52" x2="36" y2="70" stroke="rgba(201,168,76,0.5)" stroke-width="1"/><line x1="2" y1="36" x2="20" y2="36" stroke="rgba(201,168,76,0.5)" stroke-width="1"/><line x1="52" y1="36" x2="70" y2="36" stroke="rgba(201,168,76,0.5)" stroke-width="1"/><line x1="12" y1="12" x2="25" y2="25" stroke="rgba(201,168,76,0.3)" stroke-width="1"/><line x1="47" y1="47" x2="60" y2="60" stroke="rgba(201,168,76,0.3)" stroke-width="1"/><line x1="60" y1="12" x2="47" y2="25" stroke="rgba(201,168,76,0.3)" stroke-width="1"/><line x1="25" y1="47" x2="12" y2="60" stroke="rgba(201,168,76,0.3)" stroke-width="1"/></svg></g>
          <!-- Pulse rings -->
