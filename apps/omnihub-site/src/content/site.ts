...
export const siteConfig = {
  ...
  manMode: {
    ...
    description:
      'High-risk decision items are flagged and held for review. The workflow continues with zero interruption. Your team reviews. You approve or reject. OmniHub remembers.',
  },
  footer: {
