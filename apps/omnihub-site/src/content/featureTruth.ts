...
export const featureTruthLedger: readonly FeatureClaim[] = [
  ...
  },
  {
    ...
    releaseCopy: null,
    evidence: ['src/security/securityAuditLogger.ts', 'apps/omnihub-site/dashboard/utils/exportAuditLog.ts'],
    uiRoutes: [],
    apiRoutes: [],
    dataStores: ['audit_logs'],
    tests: [],
    ownerValidationRequired: false,
    notes: 'Audit export exists; full forensic replay surface not certified.',
  },
  {
    id: 'memory.fullChain',
