...
describe('Wallet Integration Flow', () => {
  ...
  describe('Wallet Connection', () => {
    ...
    it.skip('should show connected state after connection [BLOCKED(APEX-8006)]', async () => {
      vi.mocked(useAccount).mockReturnValue({
        address: mockAddress,
        isConnected: true,
        chainId: 1,
  ...
  describe('Wallet Verification', () => {
    ...
    // Tracked for a Web3 component-test refresh; left skipped to keep CI deterministic.
    it.skip('should complete verification flow successfully [BLOCKED(APEX-8007)]', async () => {
