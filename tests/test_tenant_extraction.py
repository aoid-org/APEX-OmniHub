...
class TestTenantExtraction:
    ...
    def test_extract_tenant_from_jwt_claims(self):
        ...
        mock_activity.info.headers = {
            b"authorization": (
                ...
                b".eyJzdWIiOiIxMjM0NTY3ODkwIiwidGVuYW50X2lk"
                b"IjoiYWFhYWFhYWEtYWFhYS1hYWFhLWFhYWEtYWFh"
                b"YWFhYWFhYWFhYSJ9.test"
            ),
        }
    ...
    def test_extract_tenant_from_context_metadata(self):
        ...
        input_data = {
            "workflow_id": "test-wf",
            "context": {"tenant_id": "bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"},
        }
    ...
    def test_extract_tenant_from_intent_metadata(self):
        ...
        input_data = {
            ...
            "intent": {
                "tool_name": "test_tool",
                "context": {"tenant_id": "cccccccc-cccc-cccc-cccc-cccccccccccc"},
            },
        }
    ...
    def test_extract_tenant_fallback_to_default(self):
        ...
        input_data = {"workflow_id": "test-wf", "intent": {"tool_name": "test_tool"}}
    ...
    def test_extract_tenant_priority_order(self):
        ...
        input_data = {
            "workflow_id": "test-wf",
            "context": {"tenant_id": "priority-tenant"},
            "intent": {
                "tool_name": "test_tool",
                "context": {"tenant_id": "intent-tenant"},
            },
        }
...
class TestCreateManTaskTenantInjection:
    ...
    async def test_create_man_task_includes_tenant_id(self):
        ...
        mock_db = AsyncMock()
        mock_db.upsert.return_value = {"id": "task-uuid", "workflow_id": "test-wf"}

        # Mock tenant extraction
        with (
            patch(
                "orchestrator.activities.man_mode.extract_tenant_from_activity_input"
            ) as mock_extract,
            patch(
                "orchestrator.activities.man_mode.get_database_provider"
            ) as mock_get_db,
        ):
    ...
    async def test_create_man_task_handles_extraction_failure(self):
        ...
        with (
            ...
            _ = await create_man_task(params)
