...
- **Implementable Now:** Active in this Google Antigravity IDE agent session.
- **Implementable Later:** Deferred until external API connectors or platform exports are fully linked.

The system must never imply global account scraping, hidden model-weight updates, or native always-on hooks unless those capabilities are actually active.

---

## 2. What Is Implementable Now

- Durable memory files in `omni-recall-package-2026-05-23/omni-recall/`.
...
omni-recall-package-2026-05-23/omni-recall/
  ...
  /wiki
    ...
    /open_loops
    /user_patterns
      omni-recall-user-patterns-seed.md
    /corrections
      001-migration-linter-preceding-line.md
    /rejected_patterns
    /source_indexes
