...
export const FEATURE_REGISTRY: readonly FeatureDefinition[] = [
  ...
  // NS-M-004: Named systems missing from registry — added 2026-06-17
  // Only systems with confirmed page components in apps/omnihub-site/src/pages/ are registered.
  // Pending: OmniBoard, BYOM, OmniSkills, OmniSentry (no confirmed page file; register when pages land).
  {
    id: 'physiomni',
    path: '/physiomni',
    label: 'PhysiOmni',
  ...
  },
  {
    ...
    path: '/man-mode',
    label: 'MAN Mode',
    description: 'Mandatory human oversight controls — EU AI Act Art. 14 compliance',
    icon: Eye,
    category: 'security',
    requiredScopes: ['admin'],
    isEnabled: true,
  ...
  },
  {
    ...
    path: '/maestro',
    label: 'Maestro',
    description: 'Agentic AI workload orchestrator and execution engine',
    icon: Code,
    category: 'security',
    requiredScopes: ['admin'],
    isEnabled: true,
  ...
  },
  {
    ...
    path: '/fortress',
    label: 'Fortress',
    description: 'Security hardening baseline and perimeter controls',
    icon: Shield,
    category: 'security',
    requiredScopes: ['admin'],
    isEnabled: true,
  ...
  },
  {
    ...
    path: '/omniport',
    label: 'OmniPort',
    description: 'Ingress gateway and external port management',
    icon: Network,
    category: 'integrations',
    requiredScopes: ['authenticated'],
    isEnabled: true,
  ...
  },
  {
    ...
    path: '/triforce',
    label: 'TriForce',
    description: 'Guardian · Planner · Executor — core autonomous pipeline',
    icon: Layers,
    category: 'core',
    requiredScopes: ['admin'],
    isEnabled: true,
  ...
  },
  {
    ...
    path: '/omniboard',
    label: 'OmniBoard',
    description: 'SaaS and third-party API integration gateway',
    icon: Network,
    category: 'integrations',
    requiredScopes: ['public'],
    isEnabled: true,
  ...
  },
  {
    ...
    label: 'OmniSkills',
    description: 'Modular agent memory and behavioral skill registry',
    icon: Zap,
    category: 'operations',
    requiredScopes: ['public'],
    isEnabled: true,
  ...
  },
  {
    ...
    path: '/product/byom',
    label: 'BYOM',
    description: 'Bring Your Own Model AI gateway integration',
    icon: Cpu,
    category: 'integrations',
    requiredScopes: ['public'],
    isEnabled: true,
  ...
  },
  {
    ...
    path: '/omni-sentry',
    label: 'OmniSentry',
    description: 'Circuit-breaker runtime health self-healing monitor',
    icon: Activity,
    category: 'monitoring',
    requiredScopes: ['public'],
    isEnabled: true,
