...
const DEMO_EVENT_LOG: TemporalEvent[] = [
  ...
  { id: 'te-004', type: 'incident.created', source: 'guardian', timestamp: '2026-03-20T08:03:00Z', data: { severity: 'sev2', title: 'API latency spike detected', service: 'omnilink-agent' } },
  ...
  { id: 'te-011', type: 'agent.action', source: 'omnilink-agent', timestamp: '2026-03-20T08:17:00Z', data: { action: 'summarize_pipeline', confidence: 0.95, tokens: 342 } },
