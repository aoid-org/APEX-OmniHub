      ...
      {drawerOpen && (
        <div id="mobile-nav-drawer" className="md:hidden border-t bg-background px-4 py-3 flex flex-col gap-2">
          ...
          <Link
            ...
            onClick={closeDrawer}
          >
            <span>Founder&apos;s Story</span><span className="font-mono text-[0.5rem] tracking-[0.14em] uppercase px-[0.6em] py-[0.22em] bg-apex-orange/[0.08] border border-apex-orange/[0.22] text-apex-orange2 rounded-[2px]">New</span>
          </Link>
          <Link
            to="/auth"
