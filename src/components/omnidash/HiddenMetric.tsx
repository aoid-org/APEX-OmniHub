...
export const HiddenMetric = ({ icon: Icon, label, value, valueClass }: { icon: React.ComponentType<{ className?: string }>, label: string, value: string | React.ReactNode, valueClass?: string }) => {
