...
import { Plus, Clock, Activity, Shield, Database, LineChart, Cpu, Network, Users, GitMerge, Lock } from 'lucide-react';
          ...
          <Card className="glass-card animate-in border-[hsl(var(--accent))]/30 rounded-3xl h-full flex flex-col relative overflow-hidden bg-[#0A0D14]/90 shadow-2xl">
            ...
            <div className="flex flex-col lg:flex-row h-full">
              ...
              <div className="flex-[0.8] p-5 lg:p-6 border-b lg:border-b-0 lg:border-r border-white/5 flex flex-col min-w-0 bg-white/[0.02]">
                <div className="pb-3">
                  <h2 className="text-xl font-bold text-white tracking-tight">Top 3 Outcomes</h2>
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <span className="font-medium text-sm truncate flex-1 text-gray-200">{item.title}</span>
                          <Badge variant="outline" className={`capitalize shrink-0 text-[10px] px-2 py-0 h-5 ${getBadgeStyles(item.category)}`}>
                            {item.category}
                          </Badge>
                        </div>
                        {item.next_action ? (
                          <div className="flex flex-col pl-9">
                            <span className="text-[10px] uppercase text-[hsl(var(--accent))] tracking-wider font-bold mb-0.5">Next Action</span>
                          ...
                          <div className="flex justify-start pl-9 mt-0.5">
                             <Button size="sm" variant="ghost" onClick={handleItemNextActionClick} className="shrink-0 text-xs h-6 px-0 text-gray-500 hover:text-white hover:bg-transparent">
                               Set Target →
                             </Button>
                          </div>
                        )}
                ...
                <div className="mt-4 flex gap-2 relative">
                  <div className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500 pointer-events-none">
                    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="11" cy="11" r="8"/><path d="M21 21l-4.3-4.3"/></svg>
                  </div>
                  <Input
              ...
              <div className="flex-[1.2] p-6 flex flex-col items-center justify-center relative min-w-0 border-b lg:border-b-0 lg:border-r border-white/5 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-sky-900/10 via-[#0A0D14] to-[#0A0D14] overflow-hidden">
                 ...
                 <div className="absolute top-6 flex items-center gap-3 w-full justify-center z-20">
                    <h1 className="text-2xl font-bold tracking-[0.2em] text-white">APEX <span className="text-transparent bg-clip-text bg-gradient-to-r from-gray-200 to-gray-500">AGENT</span></h1>
                    <div className="px-2 py-0.5 rounded-full bg-emerald-500/10 border border-emerald-500/20 flex items-center gap-1.5 shadow-[0_0_10px_rgba(16,185,129,0.2)]">
                       ...
                       <span className="text-[10px] text-emerald-400 uppercase font-semibold tracking-wider">Active</span>
                    </div>
                 </div>
                 ...
                 <div className="relative mt-8 mb-6 h-48 w-48 sm:h-56 sm:w-56 mx-auto flex items-center justify-center">
                    ...
                    <React.Suspense fallback={<div className="w-32 h-32 rounded-full bg-black/50 border border-white/10 animate-pulse" />}>
                      <ApexAgentAvatar />
                    </React.Suspense>
                 </div>
              ...
              <div className="flex-1 p-5 lg:p-6 flex flex-col min-w-0 bg-white/[0.01]">
                 ...
                 <div className="mb-4">
                    <h3 className="text-sm font-semibold text-white flex items-center gap-2 mb-3">
                      <span className="text-[hsl(var(--accent))]">›</span> Action Center
                    </h3>
                    <div className="space-y-2">
                      <div className="flex items-center justify-between text-xs p-2 rounded-lg hover:bg-white/5 transition-colors cursor-pointer group">
                        <span className="text-gray-300 group-hover:text-white transition-colors">• Process Payroll</span>
                        <div className="flex gap-2 items-center">
                           <span className="text-orange-400 font-medium">High</span>
                           <Button size="sm" variant="outline" className="h-6 px-2 text-[10px] bg-white/5 border-white/10 hover:bg-white/10">Run</Button>
                        </div>
                      </div>
                      <div className="flex items-center justify-between text-xs p-2 rounded-lg hover:bg-white/5 transition-colors cursor-pointer group">
                        <span className="text-gray-300 group-hover:text-white transition-colors">• Approve Expenses</span>
                        <div className="flex gap-2 items-center">
                           <span className="text-amber-500 font-medium">Pending</span>
                           <span className="text-gray-500 hover:text-white mr-1 opacity-50 group-hover:opacity-100 transition-opacity">?</span>
                        </div>
                      </div>
                      <div className="flex items-center justify-between text-xs p-2 rounded-lg hover:bg-white/5 transition-colors cursor-pointer group">
                        <span className="text-gray-300 group-hover:text-white transition-colors">• Sync QuickBooks</span>
                        <div className="flex gap-2 items-center">
                           <span className="text-emerald-400 font-medium">Ready</span>
                           <Button size="sm" variant="outline" className="h-6 px-2 text-[10px] bg-[hsl(var(--accent))]/10 border-[hsl(var(--accent))]/20 text-[hsl(var(--accent))] hover:bg-[hsl(var(--accent))]/20">Sync</Button>
                        </div>
                      </div>
                    </div>
                 </div>
                 ...
                 <div className="mt-auto bg-[#0a0d14]/80 backdrop-blur-md rounded-2xl p-4 border border-[hsl(var(--accent))]/20 shadow-[0_0_20px_rgba(56,189,248,0.05)] relative overflow-hidden group">
                    ...
                    <div className="flex items-center gap-2 mb-3 relative z-10">
                      <span className="text-[10px] font-semibold text-gray-400 uppercase tracking-widest">Live Telemetry</span>
                    </div>
