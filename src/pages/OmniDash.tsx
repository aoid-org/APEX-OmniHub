...
const Ops          = lazy(() => import('../components/omnidash/Ops'));
const Integrations = lazy(() => import('../components/omnidash/Integrations'));
const Events       = lazy(() => import('../components/omnidash/Events'));
const Entities     = lazy(() => import('../components/omnidash/Entities'));
const Runs         = lazy(() => import('../components/omnidash/Runs'));
const Tasks        = lazy(() => import('../components/omnidash/Tasks'));
const Approvals    = lazy(() => import('../components/omnidash/Approvals'));
const WorkflowStudio = lazy(() => import('../components/omnidash/WorkflowStudio'));
const LocalAgents  = lazy(() => import('../components/omnidash/LocalAgents'));
