...
import { BarChart3, MessageCircle, Mail, Music, Zap, Server, Globe, Smartphone, Bot } from 'lucide-react';
...
export const availableIntegrations: IntegrationDef[] = [
  ...
  { id: '3', name: 'Facebook', type: 'facebook', description: 'Social media integration', icon: FacebookIcon, requiresApiKey: true },
  ...
  { id: '6', name: 'YouTube', type: 'youtube', description: 'Video platform integration', icon: YoutubeIcon, requiresApiKey: true },
  { id: '7', name: 'Instagram', type: 'instagram', description: 'Social media integration', icon: InstagramIcon, requiresApiKey: true },
