...
```bash
python /home/Codex/web-art-generator/scripts/icon_generator.py \
...
```bash
python /home/Codex/web-art-generator/scripts/video_from_html.py \
...
Run full export:
```bash
python /home/Codex/web-art-generator/scripts/brand_kit_export.py \
  --config brand.json \
