...
class DebugAnalyzer:
    ...
    def add_timeline_evidence(
        self,
        first_appeared: str | None = None,
        frequency: str | None = None,
        trigger_conditions: list[str] | None = None,
        non_trigger_conditions: list[str] | None = None,
    ) -> None:
    ...
    def set_root_cause(
        self, cause: str, proof: str, eliminated_alternatives: list[str]
    ) -> None:
    ...
    def run_preflight(self) -> dict[str, bool]:
        ...
        checks = {
            ...
            "hypotheses_eliminated": len(
                [h for h in self.evidence["hypotheses"] if h["verdict"] == "ELIMINATED"]
            )
            >= 2,
            ...
            >= 3,
            "blast_radius_known": self.evidence["simulation"].get("blast_radius")
            is not None,
...
def main():
    parser = argparse.ArgumentParser(description="ONE-PASS DEBUG: Evidence Analyzer")
    parser.add_argument(
    ...
    if args.demo:
        ...
        analyzer.add_hypothesis(
            ...
            evidence_for=[],
            evidence_against=[
                "DB logs show successful queries",
