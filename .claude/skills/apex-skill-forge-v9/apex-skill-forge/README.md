# apex-skill-forge v9.1.0 — Claude edition
...
Claude Code: `/plugin marketplace add apexbusiness-systems/apex-skills-marketplace` | manual: copy this folder to `~/.claude/skills/` | claude.ai: upload `dist/apex-skill-forge-9.1.0-claude.skill` under Settings -> Capabilities. A vendor-agnostic edition of this same package ships separately for non-Claude runtimes.
...
| Metric | v4 baseline | v9.1.0 (this package) |
|---|---|---|
...
```bash
sha256sum -c dist/apex-skill-forge-9.1.0-claude.skill.sha256
