...
- Last recorded entry before backfill: `## 1.8.3` (PR #1529, committed `d22ddcf` — last commit touching `CHANGELOG.md`).
- Enumeration source: `git log origin/main --first-parent d22ddcf..origin/main` (37 first-parent commits).
