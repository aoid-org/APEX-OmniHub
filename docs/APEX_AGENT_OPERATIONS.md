...
### Lighthouse CI Workflow Cache Directive
- The `cache: npm` directive was removed from `.github/workflows/lighthouse.yml` to resolve repeated 400 errors during CI `setup-node` caching failures.
