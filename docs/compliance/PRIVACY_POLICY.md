<!-- APEX_DOC_STAMP: VERSION=v8.0-LAUNCH | LAST_UPDATED=2026-03-22 -->
# Privacy Policy
...
- **Data Export:** Navigate to Settings > Account > "Export My Data" to receive a secure download link (valid for 1 hour) containing your profile, stored resources, and associated audit logs.
- **Account Deletion:** Navigate to Settings > Account > "Delete Account". After confirmation, your account enters a 30-day grace period (soft delete), after which all personal data is permanently and irreversibly removed. An email confirmation is sent upon final deletion.
