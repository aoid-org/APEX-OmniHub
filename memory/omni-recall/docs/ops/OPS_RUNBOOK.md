...
> **2026-06-01 status:** This file remains deprecated for active operations. Use `docs/ops/OPS_RUNBOOKS_CI_GUARDRAILS.md`, `docs/infrastructure/PRODUCTION_DEPLOYMENT_GUIDE.md`, `docs/project-status/PRODUCTION_CERTIFICATION_STATUS.md`, and `docs/CURRENT_PLATFORM_STATE_2026_06_02.md` for current ops authority.
