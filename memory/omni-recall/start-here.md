...
- **Release:** `package.json` bumped `1.8.1` → `1.8.2` (CHANGELOG `1.8.2` already written). `v1.8.2` tag + GitHub release auto-cut from `package.json` on push to `main` via `compliance.yml`; no manual tagging.
